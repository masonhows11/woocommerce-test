...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="<?php echo UPP_ASSETS_URL; ?>css/bootstrap-theme.css">
    <!-- Bootstrap rtl -->
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo UPP_ASSETS_URL; ?>Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo UPP_ASSETS_URL; ?>css/AdminLTE.css">
...
<!-- jQuery 3 -->
<script src="<?php echo UPP_ASSETS_URL; ?>jquery/dist/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo UPP_ASSETS_URL; ?>jquery-ui/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
    $.widget.bridge('uibutton', $.ui.button);
</script>
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo UPP_ASSETS_URL; ?>bootstrap/dist/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo UPP_ASSETS_URL; ?>js/adminlte.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo UPP_ASSETS_URL; ?>js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo UPP_ASSETS_URL; ?>js/demo.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo UPP_ASSETS_URL; ?>bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo UPP_ASSETS_URL; ?>jquery-knob/dist/jquery.knob.min.js"></script>
