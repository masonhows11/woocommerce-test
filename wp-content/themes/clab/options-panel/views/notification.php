<div class="options-form">
    ...
    <fieldset class="posts-option-fieldset">
        ...
        <div class="form-row">
            ...
            <input type="text" name="new_user_email_title" id="email-title" value="<?php  echo esc_attr(!empty($options['new_user_email_title']) ? $options['new_user_email_title'] : '');  ?>">
        </div>

        <div class="form-row">
            <label for="email-body">متن ایمیل :</label>
            <textarea rows="10" name="new_user_email_body" id="email-body">
                <?php  echo esc_attr(!empty($options['new_user_email_body']) ? $options['new_user_email_body'] : '');  ?>
        </textarea>
        </div>
