	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="table-responsive">
				<table class="table vl-custom-table" cellspacing="0">
					<thead>
					<tr>
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="product-remove">
									...
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											'<a href="%s" class="text-decoration-none h5" aria-label="%s" data-product_id="%s" data-product_sku="%s">&times;</a>',
		...
		<div class="col-md-7">
			...
			<div class="d-md-flex mt-lg-4 mt-3 mb-4">
				<?php if ( wc_coupons_enabled() ) { ?>
					...
					<button type="submit" class="btn btn-pill btn-solid-dark mr-2  mb-2" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
